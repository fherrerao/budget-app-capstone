...
ActiveRecord::Schema[7.0].define(version: 20_220_524_033_429) do
  ...
  add_foreign_key 'entity_groups', 'entities', on_delete: :cascade
  add_foreign_key 'entity_groups', 'groups', on_delete: :cascade
